 ...
 *
 * @FormElement("yamlform_table_sort")
 */
class YamlFormTableSort extends Table {
  ...
  public function getInfo() {
    ...
    return [
      ...
      '#pre_render' => [
        ...
        [$class, 'preRenderYamlFormTableSort'],
      ],
      '#process' => [
        [$class, 'processYamlFormTableSort'],
      ],
      '#options' => [],
      '#empty' => '',
  ...
  /**
   * Prepares a 'yamlform_table_sort' #type element for rendering.
   *
   * @return array
   *   The processed element.
   */
  public static function preRenderYamlFormTableSort($element) {
    $rows = [];
  ...
  /**
   * Creates checkbox and weights to populate a 'yamlform_table_order' table.
   *
   * @param array $element
   *   An associative array containing the properties and children of the
   *   yamlform_table_order element.
   ...
   *   The processed element.
   */
  public static function processYamlFormTableSort(&$element, FormStateInterface $form_state, &$complete_form) {
  ...
  /**
   * Validates yamlform_table_other.
   */
